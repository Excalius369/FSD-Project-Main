...
const PaymentForm2 = ({ subtotal, closePaymentModal, setOrderPlaced }) => {
  ...
  const handlePayNow = async (e) => {
    ...
    Swal.fire({
      ...
      text: `Do you want to proceed with the payment of ₹${subtotal}?`,
      icon: 'question',
      ...
      if (result.isConfirmed) {
        ...
        try {
          const userId = sessionStorage.getItem('userId');
          const response = await axios.post(`/orders/create-from-cart/${userId}`);
          ...
          Swal.fire({
            ...
            // Display thank you message and redirect to homepage
            Swal.fire({
              title: 'Thank you for shopping!',
              text: 'We appreciate your purchase.',
              icon: 'success',
            }).then(() => {
              navigate('/');
            });
